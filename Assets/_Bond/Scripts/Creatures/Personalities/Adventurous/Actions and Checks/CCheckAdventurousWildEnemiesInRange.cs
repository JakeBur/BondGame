...
using UnityEngine;
public class CCheckAdventurousWildEnemiesInRange : BTChecker
{

    public CCheckAdventurousWildEnemiesInRange(string _name, CreatureAIContext _context) : base(_name, _context)
    {
        name = _name;
        context = _context;
    }
